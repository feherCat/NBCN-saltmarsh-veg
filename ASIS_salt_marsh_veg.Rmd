...
pacman::p_load(tidyverse, AER, betareg, bookdown, cowplot, english, flextable, ftExtra, ggh4x, gt, here, janitor, knitr, lemon, lmtest, lubridate, margins, monochromeR, numDeriv, officedown, officer, pairwiseAdonis, printy, statmod, stringr, stringi, vegan, xfun)
...
##### Total Plot Cover, Species Richness, & Unique Species
...
print(ggdraw(total_cover_plot(), ylim = c(-0.15,1)) +
  draw_label(bquote(bold("Figure 2.")~"Average total plot cover at"~.(params$park)*". The rate of change in mean total plot cover was not significant (i.e., rate of change = 0 %/yr)."), fontfamily = "serif", x = 0.02, y = 0.04, size = 12, hjust = 0) +
  draw_label(bquote(plain("The rate of change in mean")), fontfamily = "serif", x = 0.02, y = -0.01, size = 12, hjust = 0) +
  draw_label(bquote(plain("total plot cover was not significant (i.e., rate of change = 0 %/yr).")), fontfamily = "serif", x = 0.02, y = -0.06, size = 12, hjust = 0))
```
